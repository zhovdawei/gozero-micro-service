...
func (m *defaultGoods) QueryGoodsList(ctx context.Context, in *QueryGoodsListReq, opts ...grpc.CallOption) (*GoodsResp, error) {
	client := pb.NewUserClient(m.cli.Conn())
	return client.QueryGoodsList(ctx, in, opts...)
}

func (m *defaultGoods) QueryGoodsAttrs(ctx context.Context, in *QueryGoodsAttrsReq, opts ...grpc.CallOption) (*GoodsAttrsResp, error) {
	client := pb.NewUserClient(m.cli.Conn())
	return client.QueryGoodsAttrs(ctx, in, opts...)
}

func (m *defaultGoods) QueryGoodsDetail(ctx context.Context, in *QueryGoodsDetailReq, opts ...grpc.CallOption) (*GoodsDetailResp, error) {
	client := pb.NewUserClient(m.cli.Conn())
	return client.QueryGoodsDetail(ctx, in, opts...)
}

func (m *defaultGoods) QueryGoodsSpecById(ctx context.Context, in *QueryGoodsSpecByIdReq, opts ...grpc.CallOption) (*GoodsSpecVO, error) {
	client := pb.NewUserClient(m.cli.Conn())
	return client.QueryGoodsSpecById(ctx, in, opts...)
}

func (m *defaultGoods) QueryGoodsSpecs(ctx context.Context, in *QueryGoodsSpecsReq, opts ...grpc.CallOption) (*GoodsSpecsResp, error) {
	client := pb.NewUserClient(m.cli.Conn())
	return client.QueryGoodsSpecs(ctx, in, opts...)
}

func (m *defaultGoods) QueryGoodsSpecBySpec(ctx context.Context, in *QueryGoodsSpecBySpecReq, opts ...grpc.CallOption) (*GoodsSpecVO, error) {
	client := pb.NewUserClient(m.cli.Conn())
